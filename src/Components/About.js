    ...
    return (
      ...
      <div className="row">
         ...
         <div className="nine columns main-col">
            ...
            <p>jdneojfornfoireogineotgnojewngkrgjntughotrhthtrthhttttttttttfurbfuregurbgiutbgiutiugtiugutgutgutgutgutrgourtngortgotrsnousngoutwgoutb
               jrugheghtgntohgithtoihoiyhjiyhjyihjoiy.</p>
            <div className="row">
